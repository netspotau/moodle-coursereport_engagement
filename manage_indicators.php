...
$PAGE->navbar->add(get_string('pluginname', 'coursereport_engagement'));
$PAGE->navbar->add(get_string('manageindicators', 'coursereport_engagement'), $url);

// Display page header.
$PAGE->set_title(get_string('pluginname', 'coursereport_engagement'));
$PAGE->set_heading(get_string('pluginname', 'coursereport_engagement'));
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('manageindicators', 'coursereport_engagement'));
